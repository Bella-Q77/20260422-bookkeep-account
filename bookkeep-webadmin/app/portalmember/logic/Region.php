 ...
 * 地区列表管理=》逻辑层
 */
class Region extends PortalmemberBase
{
     ...
     * @return
     */
    public function getRegionListName($key='')
    {
        $data=$this-> getRegionColumn('','shortname','id');
        if(!empty($data[$key])){
            return $data[$key];
        }else{
            return '';
