...
class BkProject extends PortalmemberBookkeepAuth
{
    ...
    {
        $this->jump($this->logicBkProject->setField('BkProject', $this->param));
    }
    /**
     * 排序
     */
    ...
    {
        $this->jump($this->logicBkProject->setSort('BkProject', $this->param));
    }
    public function set_default()
    {
        $this->jump($this->logicBkProject->setBkProjectDefault($this->param));
    }
}