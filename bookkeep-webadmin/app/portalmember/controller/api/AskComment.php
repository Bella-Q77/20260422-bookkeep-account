 ...
 * 反馈问题控制器
 */
class AskComment extends PortalmemberBookkeepApiBase
{
    ...
    public function add()
    {
        $result = $this->logicAskComment->askCommentAdd($this->param);
        return $this->apiReturn($result);
    }

    public function addReply()
    {
        $result = $this->logicAskCommentReply->askCommentReplyAdd($this->param);
        return $this->apiReturn($result);
    }
    /**
     * 删除
    ...
    public function del()
    {
        ...
        $result = $this->logicAskComment->askCommentDel($where);
        return $this->apiReturn($result);
    }
}
