...
return [
    'tables' => [
        ...
        'sys_login_log' => [
            ...
            'columns' => [
                'id' => ['type' => 'int', 'length' => 16, 'unsigned' => false, 'autoincrement' => true, 'comment' => '主id',],
                'sys_user_id' => ['type' => 'int', 'length' => 11, 'required' => true, 'default' => 0, 'comment' => '登录用户id',],
                'name' => ['type' => 'varchar', 'length' => 64, 'required' => true, 'default' => '', 'comment' => '名称',],
                'username' => ['type' => 'varchar', 'length' => 64, 'required' => true, 'default' => '', 'comment' => '登录账号',],
                'ip' => ['type' => 'varchar', 'length' => 32, 'required' => true, 'default' => '', 'comment' => 'IP地址',],
                'describe' => ['type' => 'varchar', 'length' => 256, 'required' => true, 'default' => '', 'comment' => '描述内容',],
                'url' => ['type' => 'varchar', 'length' => 256, 'required' => true, 'default' => '', 'comment' => 'URL地址',],
                'create_time' => ['type' => 'int', 'length' => 16, 'required' => false, 'default' => 0, 'comment' => '创建日期',],
                'update_time' => ['type' => 'int', 'length' => 16, 'required' => false, 'default' => 0, 'comment' => '更新日期',],
                'org_id' => ['type' => 'int', 'length' => 16, 'required' => false, 'default' => 1, 'comment' => '企业编号',],
            ],
