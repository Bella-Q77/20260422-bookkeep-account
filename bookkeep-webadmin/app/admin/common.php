...
use app\admin\logic\SysLoginLog as LogicSysLoginLog;
...
function login_log($name = '', $describe = '')
{
    $logLogic = get_sington_object('logLogic', LogicSysLoginLog::class);
    $logLogic->loginLogDelAdd($name, $describe);
}
