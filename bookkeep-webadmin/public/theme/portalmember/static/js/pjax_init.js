...
pjax_mode=1;
pjax_mode == 1 && $(document).pjax('a[target!=_blank]', '.pjax-container');
...
$(document).on('pjax:complete', function () {
    ...
    if (ob_title_hidden != null && ob_title_hidden != '') {
        ...
        document.title = 'LingQifei | ' + ob_title_hidden;
    }
    ...
    $('.ajax-get').click(function () {
        ...
        if ((target = $(this).attr('href')) || (target = $(this).attr('url'))) {
            ...
            if ($(this).attr('is-jump') == 'true') {
                ...
                $.pjax({url: target, container: '.pjax-container'});
...
var flyalertp = function (data) {
    ...
    data.url && $.pjax({url: data.url, container: '.pjax-container'});
};
